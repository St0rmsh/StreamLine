  ...
  if (!query) {
    return (
      <div className="max-w-6xl mx-auto p-6 lg:p-10 py-32 text-center">
        ...
        <h3 className="text-lg font-display font-black text-stitch-black">Enter a search query</h3>
      ...
      <div className="mb-10 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-text-muted">
            ...
            {!error && <span className="text-stitch-black font-bold">"{query}"</span>}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-8">
        {error ? (
          <div className="py-20 text-center">
            <SearchIcon size={48} className="mx-auto text-stitch-grey mb-4" />
            <h3 className="text-lg font-display font-black text-stitch-black">Signal Lost</h3>
